...
class CircleTestCase(unittest.TestCase):
    ...
    def test_area(self):
        self.assertEqual(area(10), 10 * 10 * math.pi)
        self.assertEqual(area(0), 0)
        self.assertEqual(area(2.5), 2.5 * 2.5 * math.pi)
        self.assertEqual(area(1.545), 1.545 * 1.545 * math.pi)
    
    def test_prerimetr(self):
        self.assertEqual(perimeter(1), math.pi * 2 * 1)
        self.assertEqual(perimeter(10), math.pi * 2 * 10)
        self.assertEqual(perimeter(2.5), math.pi * 2 * 2.5)
        self.assertEqual(perimeter(34.1234), math.pi * 2 * 34.1234)
